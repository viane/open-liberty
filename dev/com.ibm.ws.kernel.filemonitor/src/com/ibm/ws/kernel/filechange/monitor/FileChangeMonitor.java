 ...
 *******************************************************************************/
package com.ibm.ws.kernel.filechange.monitor;
...
public interface FileChangeMonitor {
    /**
     * Invokes the notifyFileChanges operation, which can be catused to notify the Liberty profile of created, modified, or deleted files. This is most useful
    ...
    long registerFile(ArrayList<String> filePaths);

    boolean listenFileChange();
}
